...
public class MemberApiController {
    ...
    public ResponseEntity<ResponseDto<String>> update(
        ...
        return ResponseEntity.ok(new ResponseDto<>(UPDATE_PROFILE.getMessage(), null, true));
    }
    ...
    public ResponseEntity<ResponseDto<ProfileDto>> getProfile(
        ...
        return ResponseEntity.ok(new ResponseDto<>(PROFILE_INFO.getMessage(), profileDto, true));
    }
